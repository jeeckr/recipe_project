...
//
//     final responseDetailRecipe = responseDetailRecipeFromJson(jsonString);

import 'dart:convert';

ResponseDetailRecipe responseDetailRecipeFromJson(String str) => ResponseDetailRecipe.fromJson(json.decode(str));

String responseDetailRecipeToJson(ResponseDetailRecipe data) => json.encode(data.toJson());

class ResponseDetailRecipe {
    ...
    factory ResponseDetailRecipe.fromJson(Map<String, dynamic> json) => ResponseDetailRecipe(
        method: json["method"],
        status: json["status"],
